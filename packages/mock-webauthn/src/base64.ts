...
export function bigEndianBytes(value: Uint32Array[0], length: number): Uint8Array {
...
export function authenticatorDataFlags(userPresent: boolean, userVerified: boolean, attestation: boolean, extensions: boolean): number {
